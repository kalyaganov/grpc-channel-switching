...
var grpc = require('grpc-middleware');
...
function preHook(context, request) {
    console.log('Request meta: ', request.metadata)
}
...
function doSayHello(call, callback) {
  callback(null, {message: 'Hello! '+ call.request.name + " " + call});
}
 ...
 */
function getServer() {
  var server = new grpc.Server(null, preHook, postHook);
